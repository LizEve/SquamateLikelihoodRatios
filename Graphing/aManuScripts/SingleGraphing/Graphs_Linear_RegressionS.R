...
a.lr.80m <- LR(all.80m,h,cc1,40,40,5,100,100,10,0,45,"b. TvS - 80m") 
#a.lr.80m
...
quartz()
a.lr <- LR(all.d,h,cc1,40,40,5,60,60,10,0,25,"c. AIvSA - All")
#a.lr
 
a.lr.80m <- LR(all.80m,h,cc1,40,40,2,60,60,10,0,25,"d. AIvSA - 80m") 
#a.lr.80m
