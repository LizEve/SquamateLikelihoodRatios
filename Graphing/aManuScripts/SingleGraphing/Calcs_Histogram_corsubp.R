...
# Read in data
dfmid <- read_excel("/Users/chatnoir/Projects/Squam/Graphs/Tables/Correlation_Sept16.xlsx")
...
fname <- paste("/Users/ChatNoir/Projects/Squam/Graphs/Tables/Corr_rand_pvals_mmb.xlsx",sep='')
