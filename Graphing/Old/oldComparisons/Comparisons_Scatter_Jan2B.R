...
z
ggsave("Burbrink_Scatter_SC.pdf", plot=z, 
...
z
ggsave("Burbrink_Scatter_TP.pdf", plot=z, 
       width = 7, height = 6, units = "in", 
       device = 'pdf',bg = "transparent")
...
z
ggsave("Burbrink_Scatter_AI.pdf", plot=z, 
       width = 7, height = 6, units = "in", 
       device = 'pdf',bg = "transparent")
...
z
ggsave("Burbrink_Scatter_AItox.pdf", plot=z, 
       width = 7, height = 6, units = "in", 
       device = 'pdf',bg = "transparent")
...
z
ggsave("Burbrink_Scatter_TvS.pdf", plot=z, 
       width = 7, height = 6, units = "in", 
       device = 'pdf',bg = "transparent")
...
z
ggsave("Burbrink_Scatter_AIvS.pdf", plot=z, 
       width = 7, height = 6, units = "in", 
       device = 'pdf',bg = "transparent")
...
z
ggsave("Burbrink_Scatter_SAvS.pdf", plot=z, 
       width = 7, height = 6, units = "in", 
       device = 'pdf',bg = "transparent")
...
z
ggsave("Burbrink_Scatter_SIvS.pdf", plot=z, 
       width = 7, height = 6, units = "in", 
       device = 'pdf',bg = "transparent")
