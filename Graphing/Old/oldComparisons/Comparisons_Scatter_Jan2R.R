...
load("/Users/ChatNoir/Projects/Squam/Graphs/Reeder/BFcalcs_Reeder.RData")
load("/Users/ChatNoir/Projects/Squam/Graphs/Reeder/dGLScalcs_Reeder.RData")
...
z
ggsave("Reeder_Scatter_SC.pdf", plot=z, 
...
z
ggsave("Reeder_Scatter_TP.pdf", plot=z, 
       width = 7, height = 6, units = "in", 
       device = 'pdf',bg = "transparent")
...
z
ggsave("Reeder_Scatter_AI.pdf", plot=z, 
       width = 7, height = 6, units = "in", 
       device = 'pdf',bg = "transparent")
...
z
ggsave("Reeder_Scatter_AItox.pdf", plot=z, 
       width = 7, height = 6, units = "in", 
       device = 'pdf',bg = "transparent")
...
z
ggsave("Reeder_Scatter_TvS.pdf", plot=z, 
       width = 7, height = 6, units = "in", 
       device = 'pdf',bg = "transparent")
...
z
ggsave("Reeder_Scatter_AIvS.pdf", plot=z, 
       width = 7, height = 6, units = "in", 
       device = 'pdf',bg = "transparent")
...
z
ggsave("Reeder_Scatter_SAvS.pdf", plot=z, 
       width = 7, height = 6, units = "in", 
       device = 'pdf',bg = "transparent")
...
z
ggsave("Reeder_Scatter_SIvS.pdf", plot=z, 
       width = 7, height = 6, units = "in", 
       device = 'pdf',bg = "transparent")
