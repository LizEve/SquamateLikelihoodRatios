...
quartz()
# x y
a.lr <- LR(all.d,h,cc1,60,60,20,100,100,20,0,70,"a. TvS - All")
a.lr

a.lr.80m <- LR(all.80m,h,cc1,40,40,10,100,100,10,0,20,"b. TvS - 80m") 
a.lr.80m
...
quartz()
a.lr <- LR(all.d,h,cc1,40,40,20,60,60,20,0,30,"c. AIvSA - All")
a.lr
...
figm <- annotate_figure(m2t2,
                        bottom = text_grob("dGLS", size = 16),
                        left = text_grob("ln(BF)",  size = 16, rot = 90),
                        top = text_grob("Streicher",  size = 18))
figm
