...
setwd("/Users/ChatNoir/Projects/Squam/scripts/Constraints/Streicher")
...
makeFile = function(df){
  fname = paste('Streicher_',deparse(substitute(df)),'_iq.txt',sep='')
