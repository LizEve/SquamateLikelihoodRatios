...
def writeTaxaNex(globber,folder):
    cwd = os.getcwd()
    os.chdir(folder)
    allTaxa=[]
    for f in glob.glob(globber):
...
def main():
    nexFolder = "/Users/ChatNoir/Projects/Squam/Singhal/SinghalData"
    constraintsFile = "/Users/ChatNoir/Projects/Squam/scripts/Constraints/Singhal_IQ_sclero.txt" 
    constraintsTree = '/Users/ChatNoir/Projects/Squam/scripts/Constraints/Singhal_IQ_sclero_tree.txt'
    constraintsFile1 = "/Users/ChatNoir/Projects/Squam/scripts/Constraints/Singhal_IQ_toxpoly.txt" 
    constraintsTree1 = '/Users/ChatNoir/Projects/Squam/scripts/Constraints/Singhal_IQ_toxpoly_tree.txt'
    constraintsFile2 = "/Users/ChatNoir/Projects/Squam/scripts/Constraints/Singhal_IQ_toxai.txt" 
    constraintsTree2 = '/Users/ChatNoir/Projects/Squam/scripts/Constraints/Singhal_IQ_toxai_tree.txt'
    constraintsFile3 = "/Users/ChatNoir/Projects/Squam/scripts/Constraints/Singhal_IQ_toxsa.txt" 
    constraintsTree3 = '/Users/ChatNoir/Projects/Squam/scripts/Constraints/Singhal_IQ_toxsa_tree.txt'
    constraintsFile4 = "/Users/ChatNoir/Projects/Squam/scripts/Constraints/Singhal_IQ_toxsi.txt" 
    constraintsTree4 = '/Users/ChatNoir/Projects/Squam/scripts/Constraints/Singhal_IQ_toxsi_tree.txt'

    # Get list of all taxa 
    #aT = writeTaxaNex("*phy",nexFolder)
    #aT = writeTaxaNex("*nex",nexFolder)
    f=open('SinghalTaxa.pkl','rb')
    aT = pickle.load(f)
    f.close()
    print(len(aT))
