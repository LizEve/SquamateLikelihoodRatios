...
def main():
	...
	mainDir='/Users/ChatNoir/Projects/Squam/Singhal/SinghalOGSS/'
	bbFiles = ["_sclero.bb","_toxpoly.bb"]
	outFile = '/Users/ChatNoir/Projects/Squam/Singhal/missingCladesOG.csv'
	...
	reqClades=['Iguania','Snake','Outgroup']
