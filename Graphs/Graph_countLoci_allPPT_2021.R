...
load("/Users/ChatNoir/Projects/Squam/scripts_ch1/Graphing/DataFiles/Calcs_countLoci_2021.RData")
...
cc <- c("#450156", "#30668d","#578529","#666666", "#b3b3b3")
bp <- BarPlot(B.TX.pos,B.TX.pos$Data.Set,B.TX.pos$Percent.Loci,B.TX.pos$Hpos,cc,"a) ln(BF) - Positive support") + 
  ...
  theme(strip.background = element_blank()) + theme(plot.title = element_text(hjust = -0.06,vjust=0, size=10))
...
ggsave("Bar_support_TX.pdf", plot=fig,width = 7, height = 7, units = "in", device = 'pdf',bg = "transparent")
...
cc <- c("#09671D", "#AB5707","#666666", "#b3b3b3")
bp <- BarPlot(B.TS.pos,B.TS.pos$Data.Set,B.TS.pos$Percent.Loci,B.TS.pos$Hpos,cc,"a) ln(BF) - Positive support") + 
  ...
  theme(strip.text.x = element_blank()) + theme(plot.title = element_text(hjust = -0.06,vjust=0, size=10))
...
ggsave("Bar_support_TS.pdf", plot=fig,width = 7, height = 7, units = "in", device = 'pdf',bg = "transparent")
